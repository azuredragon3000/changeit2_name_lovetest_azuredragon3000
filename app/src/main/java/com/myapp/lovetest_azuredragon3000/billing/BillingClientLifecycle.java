...
public class BillingClientLifecycle implements DefaultLifecycleObserver, PurchasesUpdatedListener,
     ...
     */
    public EventSingleLive<List<Purchase>> purchaseUpdateEvent = new EventSingleLive<>();
            ...
            billingClient.startConnection(new BillingClientStateListener() {
                ...
                public void onBillingSetupFinished(BillingResult billingResult) {
                    if (billingResult.getResponseCode() ==  BillingClient.BillingResponseCode.OK) {
                        ...
                        Log.d(TAG, "billingclient is successful connection");
                        querySkuDetails();
                        //queryPurchases();
                    }
                }
                ...
                public void onBillingServiceDisconnected() {
                    ...
                    Log.d(TAG, "billingclient is not successful connection");
                }
                        ...
                        switch (responseCode) {
                            case BillingClient.BillingResponseCode.OK:
                                ...
                                if (skuDetailsList == null) {
                                    ...
                                    //result = result + " conect success";
                                    //result = result + skuDetailsList.get(0).toString() + " - size: "+skuDetailsList.size();
                                    result = "";
                                    ...
                                    for (SkuDetails skuDetails : skuDetailsList) {
                                        ...
                                        result = result + skuDetails.getSku();
                                    }
                                    ...
                                    if (skuDetailsCount == expectedSkuDetailsCount) {
                                        ...
                                        //result = "onSkuDetailsResponse: Found " + skusWithSkuDetails + " SkuDetails";
                                    } else {
                                        Log.e(TAG, "onSkuDetailsResponse: " +
                                                "Expected " + expectedSkuDetailsCount + ", " +
